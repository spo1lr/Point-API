...
public class MemberController {
    ...
    @PostMapping("")
    public ResponseEntity<Response<CreateMemberResponseDTO>> createMember(@Valid @RequestBody CreateMemberRequestDTO request) {
    ...
    public ResponseEntity<Response<Void>> updateMember(@PathVariable("memberId") Long memberId, @Valid @RequestBody UpdateMemberRequestDTO request) {
